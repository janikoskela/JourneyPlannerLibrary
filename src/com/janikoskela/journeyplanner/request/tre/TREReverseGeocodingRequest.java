 ...
 * @author janikoskela
 */
public class TREReverseGeocodingRequest extends TRERequest implements Serializable  {
    ...
    public TREReverseGeocodingRequest(String apiUsername, String apiPassword, CoordinateSystem inCoordinateSystem, CoordinateSystem outCoordinateSystem, Coordinates coordinates) {
