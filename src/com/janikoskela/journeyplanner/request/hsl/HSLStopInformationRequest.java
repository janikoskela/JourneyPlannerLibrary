 ...
 * @author janikoskela
 */
public class HSLStopInformationRequest extends HSLRequest implements Serializable {
    ...
    public HSLStopInformationRequest(String code, String apiUsername, String apiPassword, CoordinateSystem inCoordinateSystem, CoordinateSystem outCoordinateSystem) {
    ...
    protected List<Stop> parseResponse(String response) {
        return HSLParseFactory.parseStopInformationResponse(response);
    }
